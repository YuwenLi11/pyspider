...
m pyspider.libs.base_handler import *
import json
import pymysql
import datetime
import os
...
CONFIG_FILE_PATH = "/data/apps/crawler/envi-pyspider/config_file/treatment_patientslikeme.json"
...
class Handler(BaseHandler):
    ...
    def index_page(self, response):
        ...
        ### If the page level is on detail page
            ...
            self.crawl(xhr_url, callback=self.extra_detail,
                       save={'wsid': wsid, 'qid': qid, 'plv': plv, 'item_name': item_name},
                       fetch_type=self.fetch_method, allow_redirects=False)
