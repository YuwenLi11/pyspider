...
CONFIG_FILE_PATH = "/data/apps/crawler/envi-pyspider/config_file/dictionary_mcd8_speedup.json"
...
class Handler(BaseHandler):
    ...
    def __init__(self):
        ...
        self.u1 = self.data['START_URL_1']
        self.u2 = self.data['START_URL_2']
        self.u3 = self.data['START_URL_3']
        self.u4 = self.data['START_URL_4']
        self.u5 = self.data['START_URL_5']
        self.u6 = self.data['START_URL_6']
        self.u7 = self.data['START_URL_7']
        self.u8 = self.data['START_URL_8']
        self.u9 = self.data['START_URL_9']
        self.stop_list = self.data['stop_list']
    ...
    def on_start(self):
        ...
        self.crawl(self.u1, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u2, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u3, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u4, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u5, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u6, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u7, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u8, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)
        self.crawl(self.u9, callback=self.index_page,save={'wsid': wsid, 'qid': 0},fetch_type=self.fetch_method)



    @config(age=10 * 24 * 60 * 60)
    def index_page(self, response):
        stop = ['http://www.mcd8.com/w/a-dose-of-physic', 'http://www.mcd8.com/w/b-lymphocytes', 'http://www.mcd8.com/w/c-peptide']
        ...
        if response.url in self.stop_list:
            return
